...
public final class CommonServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.lyj.Request,
      com.lyj.Response> getMethodMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "method",
      requestType = com.lyj.Request.class,
      responseType = com.lyj.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.lyj.Request,
      com.lyj.Response> getMethodMethod() {
      ...
      synchronized (CommonServiceGrpc.class) {
        if ((getMethodMethod = CommonServiceGrpc.getMethodMethod) == null) {
          CommonServiceGrpc.getMethodMethod = getMethodMethod = 
              io.grpc.MethodDescriptor.<com.lyj.Request, com.lyj.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "CommonService", "method"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lyj.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.lyj.Response.getDefaultInstance()))
  ...
  public static abstract class CommonServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void method(com.lyj.Request request,
  ...
  public static final class CommonServiceFutureStub extends io.grpc.stub.AbstractStub<CommonServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.lyj.Response> method(
        com.lyj.Request request) {
